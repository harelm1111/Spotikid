...
const COPY = {
  he: {
    ...
    tabActivities: "המקומות שלי",
    tabReviews: "הביקורות שלי",
    tabSaved: "שמורים",
    noActivities: "עדיין לא הוספת מקומות.",
    noReviews: "עדיין לא כתבת ביקורות.",
    noSaved: "עדיין לא שמרת מקומות. לחצו על הלב בכל כרטיס כדי לשמור!",
    addOne: "הוספת מקום ראשון",
    signOut: "התנתקות",
    loading: "טוען...",
    yourReviewOn: "הביקורת שלך על",
    adminImport: "ייבוא מקומות",
    ...
    adminBadge: "מנהל",
    mostViewed: "המקומות הנצפים ביותר",
  ...
  en: {
    ...
    tabActivities: "My Places",
    tabReviews: "My Reviews",
    tabSaved: "Saved",
    noActivities: "You haven't added any places yet.",
    noReviews: "You haven't written any reviews yet.",
    noSaved: "No saved places yet. Tap the heart on any card to save it!",
    addOne: "Add your first place",
    signOut: "Sign out",
    loading: "Loading...",
    yourReviewOn: "Your review on",
    adminImport: "Import places",
